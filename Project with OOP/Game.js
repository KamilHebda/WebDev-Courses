class Game {
  constructor(start) {
    ...
    this.cards = [...document.querySelectorAll('div.color')];
  ...
  startGame() {
    if (this.inputBid.value < 1) return alert('Your amount is too low! Please increase your amont above 1');
    const bid = Math.floor(this.inputBid.value);

    if (!this.wallet.checkCanPlay(bid)) {
      return alert('Your amount is too low or there is an incorrect value!')
    }
